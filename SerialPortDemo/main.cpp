 ...
 * @LastEditTime: 2026-01-21 15:54:29
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        while (true) {
            ...
            auto value = spectrometer.read(SerialPortCmd::RO_SensorWidth);
            std::cout << "readCmd: "
            ...
            std::this_thread::sleep_for(std::chrono::seconds(2));
            std::cout << "writeCmd: "
                      << spectrometer.write(SerialPortCmd::RW_LinePeriod, 500)
                      << std::endl;

            std::this_thread::sleep_for(std::chrono::seconds(2));
            std::cout << "writeCmd: "
                      << spectrometer.write(SerialPortCmd::RW_ExposureTime, 420)
                      << std::endl;
        }
    }
